...
public class RxComprehensionsTest {
    ...
    @Test
    public void threeFM() {
        Assert.assertEquals(RxComprehensions.forFM(zero(3), one(true), two("result"), three("other")).toBlocking().first(), "other");
    }

    @Test
    public void fourFM() {
        Assert.assertEquals(RxComprehensions.forFM(zero(4), one(true), two("result"), three("other"), four("other".length())).toBlocking().first(), new Long("other".length()));
    }

    @Test
    public void fiveFM() {
        Assert.assertEquals(RxComprehensions.forFM(zero(1), one(true), two("result"), three("other"), four("other".length()), five("other".length() < 5)).toBlocking().first(), false);
    }

    @Test
    public void sixFM() {
        Assert.assertEquals(RxComprehensions.forFM(zero(1), one(true), two("result"), three("other"), four("other".length()), five("other".length() < 5), six(Boolean.toString(false))).toBlocking().first(), "false");
    }

    @Test
    public void sevenFM() {
        Assert.assertEquals(RxComprehensions.forFM(zero(1), one(true), two("result"), three("other"), four("other".length()), five("other".length() < 5), six(Boolean.toString(false)), seven("true")).toBlocking().first(), false);
    }

    @Test
    public void eightFM() {
        Assert.assertEquals(RxComprehensions.forFM(zero(1), one(true), two("result"), three("other"), four("other".length()), five("other".length() < 5), six(Boolean.toString(false)), seven("true"), eight(Long.class)).toBlocking().first(), Long.class);
    }
    ...
    public void nineFM() {
        ...
        observer.assertValues(1, true, "result", "other", (long) "other".length(), "other".length() < 5, Boolean.toString(false), false, Long.class);
    }
    ...
    private Func6<Integer, Boolean, String, String, Long, Boolean, Observable<String>> six(final String string) {
        return new Func6<Integer, Boolean, String, String, Long, Boolean, Observable<String>>() {
            @Override
            public Observable<String> call(Integer integer, Boolean aBoolean, String s, String s2, Long aLong, Boolean aBoolean2) {
                return Observable.just(string);
            }
        };
    }

    private Func7<Integer, Boolean, String, String, Long, Boolean, String, Observable<Boolean>> seven(final String parameter) {
        return new Func7<Integer, Boolean, String, String, Long, Boolean, String, Observable<Boolean>>() {
            @Override
            public Observable<Boolean> call(Integer integer, Boolean aBoolean, String s, String s2, Long aLong, Boolean aBoolean2, String s3) {
                return Observable.just(!Boolean.valueOf(parameter));
            }
        };
    }

    private <T> Func8<Integer, Boolean, String, String, Long, Boolean, String, Boolean, Observable<Class<T>>> eight(final Class<T> item) {
        return new Func8<Integer, Boolean, String, String, Long, Boolean, String, Boolean, Observable<Class<T>>>() {
            @Override
            public Observable<Class<T>> call(Integer integer, Boolean aBoolean, String s, String s2, Long aLong, Boolean aBoolean2, String s3, Boolean aBoolean3) {
    ...
    private <T> Func9<Integer, Boolean, String, String, Long, Boolean, String, Boolean, Class<T>, Observable<Object>> nine() {
        return new Func9<Integer, Boolean, String, String, Long, Boolean, String, Boolean, Class<T>, Observable<Object>>() {
            @Override
            public Observable<Object> call(Integer integer, Boolean aBoolean, String s, String s2, Long aLong, Boolean aBoolean2, String s3, Boolean aBoolean3, Class<T> o) {
